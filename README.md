...
A Python Tkinter utility for IT Lyceans that provides one-click installation of essential IT tools, programming software, academic utilities, and LPU’s commonly used digital platforms.

---

## 👥 Team

<span style="color:#dc143c; font-weight:bold;">interface.py:</span> <span style="color:#ffffff;">Kyle Garcia</span>
